    ...
    <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <router-link to="/weeklyrank" class="btn btn-info mr-2">Weekly Rank</router-link>
                        ...
                        <div class="col-md-4">
                            <div class="card card-widget widget-user m-3">
                                ...
                                <div class="widget-user-image" style="margin-left: 0; top: 50%; transform: translateX(-50%) translateY(-50%)">
                                    <img src="@/assets/img/Weekly-Silver.png" style="border: none; width: 150px; cursor: pointer" data-toggle="modal" data-target="#modal-rank2">
                                </div>
