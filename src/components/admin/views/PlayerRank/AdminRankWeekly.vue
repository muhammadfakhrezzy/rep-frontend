    ...
    <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <router-link to="/admin/weeklyrank" class="btn btn-info mr-2">Weekly Rank</router-link>
                    <router-link to="/admin/monthlyrank" class="btn btn-outline-success mr-2">Monthly Rank</router-link>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 mt-3">
                            <h3 class="text-center">WEEKLY RANK</h3>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="card card-widget widget-user m-3">
                                ...
                                <div class="widget-user-image" style="margin-left: 0; top: 48%; transform: translateX(-50%) translateY(-50%)" data-toggle="modal" :data-target="['#modal' + rank[0].detail_user.id]">
                                 ...
                                 <div style="position: absolute; top: 0" class="widget-user-badge">
                                    <img style="width: 40px" :src="badge[0]" alt="badge">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                    <div class="col-sm-4 border-right">
