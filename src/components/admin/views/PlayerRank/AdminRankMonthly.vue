    ...
    <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <router-link to="/admin/dailyrank" class="btn btn-outline-warning mr-2">Daily Rank</router-link>
                    <router-link to="/admin/weeklyrank" class="btn btn-outline-info mr-2">Weekly Rank</router-link>
                    <router-link to="/admin/monthlyrank" class="btn btn-success mr-2">Monthly Rank</router-link>
                    <router-link to="/admin/globalrank" class="btn btn-outline-success">Global Rank</router-link>
                </div><!-- /.container-fluid -->
            </div>
            <!-- /.content-header -->
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-4">
                            <div class="card card-widget widget-user m-3">
                                ...
                                <div class="widget-user-image" style="margin-left: 0; top: 50%; transform: translateX(-50%) translateY(-50%)">
                                    <img src="@/assets/img/Monthly-Silver.png" style="border: none; width: 160px; cursor: pointer" data-toggle="modal" :data-target="['#modal' + rank[1].detail_user.id]">
                                </div>
                                <div style="position: absolute; top: 0" class="widget-user-badge">
                                    <img style="width: 40px" :src="badge[1]" alt="badge">
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card card-widget widget-user m-3">
                                ...
                                <div class="widget-user-image" style="margin-left: 0; top: 50%; transform: translateX(-50%) translateY(-50%)" data-toggle="modal" :data-target="['#modal' + rank[0].detail_user.id]">
                        ...
                        <div class="col-md-4">
                            <div class="card card-widget widget-user m-3">
                                ...
                                <div style="position: absolute; top: 0" class="widget-user-badge">
                                    <img style="width: 50px" :src="badge[2]" alt="badge">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-sm-4 border-right">
                            ...
                            <div class="modal-body p-0">
                                <div class="card card-olive card-outline mb-0">
                                    <div class="card-body box-profile">
                                        ...
                                        <router-link :to="{name: 'admin-view', params: {id: value.data.detail_user.id, email: value.data.detail_user.email}}">
